...
{************************ Show custom validation information **********************************************}
{let $validationResult = array($object, $attribute)|myvideo_validate}
{if $validationResult|myvideo_validate_get_facts|count}

    <div class="custom-validation {if $validationResult|myvideo_validate_is_ok}myvideo-info{else}myvideo-error{/if}">
    {def $output = $validationResult|myvideo_validate_get_facts|implode('<br />')}
    {$output}
    </div>
{/if}
{************************ END - Show custom validation information **********************************************}
