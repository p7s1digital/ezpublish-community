...
<script type="text/javascript">
    ...
    // translations
    ez.translations = ez.translations || {};
    ez.translations.confirmDiscard = "{/literal}{'Are you sure you want to discard the draft?'|i18n( 'design/admin/content/edit' )|wash(javascript)}{literal}";

    // current data
    ez.currentContentObjectId = "{/literal}{$object.id}{literal}";
    ez.previewUrl = "{/literal}{ezini('Frontend', 'PreviewURL', 'environment.ini')}{literal}";
            ...
            <div id="controlbar-top" class="controlbar controlbar-fixed">
                {* DESIGN: Control bar START *}<div class="box-bc"><div class="box-ml">
                        <div class="button-left">
                            ...
                            <input class="button trigger-preview-input" value="{'Save and Preview'|i18n( 'design/admin/content/edit' )}" title="{'Save a draft and open a new window with the preview'|i18n( 'design/admin/content/edit' )}">
                            <input style="display:none;" class="button" type="submit" name="StoreButton"  />
                            ...
                            <input class="button" type="submit" name="DiscardButton" value="{'Discard draft'|i18n( 'design/admin/content/edit' )}" title="{'Discard the draft that is being edited. This will also remove the translations that belong to the draft (if any).'|i18n( 'design/admin/content/edit' ) }" />
                        </div>
                ...
                <div class="context-block">
                    ...
                    <div class="controlbar">
                        ...
                        <div class="block">
                            ...
                            <input class="defaultbutton" type="submit" name="PublishButton" value="{'Send for publishing'|i18n( 'design/admin/content/edit' )}" title="{'Publish the contents of the draft that is being edited. The draft will become the published version of the object.'|i18n( 'design/admin/content/edit' )}" />
                            <input class="button trigger-preview-input" value="{'Save and Preview'|i18n( 'design/admin/content/edit' )}" title="{'Save a draft and open a new window with the preview'|i18n( 'design/admin/content/edit' )}">
                            <input class="button" style="display:none;" type="submit" name="StoreButton"  />
                            <input class="button" type="submit" name="StoreButton" value="{'Store draft'|i18n( 'design/admin/content/edit' )}" title="{'Store the contents of the draft that is being edited and continue editing. Use this button to periodically save your work while editing.'|i18n( 'design/admin/content/edit' )}" />
                            <input class="button" type="submit" name="StoreExitButton" value="{'Store draft and exit'|i18n( 'design/admin/content/edit' )}" title="{'Store the draft that is being edited and exit from edit mode. Use when you need to exit your work and return later to continue.'|i18n( 'design/admin/content/edit' )}" />
                            <input class="button" type="submit" name="DiscardButton" value="{'Discard draft'|i18n( 'design/admin/content/edit' )}" title="{'Discard the draft that is being edited. This will also remove the translations that belong to the draft (if any).'|i18n( 'design/admin/content/edit' ) }" />
