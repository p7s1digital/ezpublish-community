...
class Version20130905130544 extends eZPublishPackageMigration
{
    const ROLE_NAME = 'Create and View MyVideo ImageGallery ';
    const CONTENT_CLASS_IDENTIFIER = 'myvideo_image_gallery';
    ...
    protected $node =
        ...
        array(
            ...
            'remote_id' => 'myvideo-content-folder-image-gallery',
            'attributes' => array(
                'name' => 'MyVideo Bildergalerie',
                'short_name' => 'MyVideo Bildergalerie',
                'description' => 'Bildergalerie von MyVideo',
                'short_description' => 'Bildergalerie von MyVideo'
            )
        );

    public function up(Schema $schema)
    {
        $this->installPackage('myvideo_image_gallery', 'myvideo_image_gallery-1.0-1.ezpkg');
        $this->addSql(
    ...
    public function down(Schema $schema)
    {
        ...
        // REMOVE TREE NODE 'MyVideo ImageGallery' ///////////////////////////////////////////////////////////////
