 ...
 */
class Version20131007114814 extends eZPublishPackageMigration
{
    const ROLE_NAME = 'Create and View MyVideo SOLR Suggestions';
    const CONTENT_CLASS_IDENTIFIER = 'myvideo_solr_suggestions';
    const USER_GROUP_EDITORS_REMOTE_ID = 'myvideo-user_group-3';

    public function up(Schema $schema)
    {
        $this->installPackage(self::CONTENT_CLASS_IDENTIFIER, 'myvideo_solr_suggestions-1.0-1.ezpkg');
        $this->addSql(
            sprintf("SELECT 'Success: MyVideo SOLR Suggestions - initial installation';")
        );
