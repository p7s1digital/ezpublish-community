 ...
 */
class Version20130603104836 extends eZPublishPackageMigration
{

    protected $workflowGroupName = 'MyVideo Workflows';

    protected $workflow = array(
        'name' => 'MyVideo Preview',
        'type' => 'group_ezserial'
    );

    protected $event = array(
        'placement' => 1,
        'type' => 'event_myvideopreview',
        'description' => 'Beschreibung, nach jedem Speichern eines Entwurfs.'
    );
    ...
    public function up(Schema $schema)
    {
        ...
        $triggers = array(
            array('function' => 'preview', 'connectType' => 'a'),
        );

        foreach ($triggers as $trigger) {
            $trigger['module'] = 'myvideopublish';
