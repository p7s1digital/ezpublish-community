...
class Version20131122000000 extends eZPublishPackageMigration
{
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql("ALTER TABLE myvideotracking DROP COLUMN ivw_two_category");
        $this->addSql("ALTER TABLE myvideotracking DROP COLUMN ivw_two_channel");
        $this->addSql("ALTER TABLE myvideotracking DROP COLUMN ivw_two_format");
    }
}
